...
const properties1 = async (effects)=>{
    return {
        result: {
            "API URL": {
                type: "string",
...
const migration = mod3.migrations;
const health = {
    async web (effects, duration) {
        return mod4.checkWebUrl("http://bitagent.embassy:8000/health")(effects, duration).catch(mod4.catchError(effects));
    }
};
